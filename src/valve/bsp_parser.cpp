...
)
{
    ...
    try {
        ...
        bool baseMapParsed =  parse_lump( file, bsp::lump_t::id::vertices, vertices )
            ...
            && parse_lump( file, bsp::lump_t::id::tex_data, tex_datas )
            && parse_lump( file, bsp::lump_t::id::brushes, brushes )
            && parse_lump( file, bsp::lump_t::id::brush_sides, brush_sides )
            && parse_lump( file, bsp::lump_t::id::texdata_string_table, texdataStringTable )
            && parse_lump( file, bsp::lump_t::id::texdata_string_data, texdataStringData)
